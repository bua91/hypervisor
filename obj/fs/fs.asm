...
00000000008005f3 <bc_pgfault>:
  ...
  80077e:	00 00 00 
  800781:	be 42 00 00 00       	mov    $0x42,%esi
...
0000000000804ee1 <ipc_send>:
  ...
  804f51:	00 00 00 
  804f54:	be 4b 00 00 00       	mov    $0x4b,%esi
...
0000000000806a9f <_pipeisclosed>:
  ...
  806abd:	8b 80 d8 00 00 00    	mov    0xd8(%rax),%eax
  ...
  806b06:	8b 80 d8 00 00 00    	mov    0xd8(%rax),%eax
