...
#endif
#line 66 "../kern/sched.c"
			env_run(&envs[k]);
		}
	}

	if (curenv && curenv->env_status == ENV_RUNNING) {
#line 72 "../kern/sched.c"
#ifndef VMM_GUEST
		...
		env_run(curenv);
#endif // !VMM_GUEST
#line 85 "../kern/sched.c"
		env_run(curenv);
	}

#line 106 "../kern/sched.c"
