...
#line 19 "../kern/syscall.c"
#include <kern/sched.h>
#line 22 "../kern/syscall.c"
#include <kern/time.h>
#line 25 "../kern/syscall.c"
#include <kern/e1000.h>
#line 28 "../kern/syscall.c"
#ifndef VMM_GUEST
#include <vmm/ept.h>
#include <vmm/vmx.h>
#endif
#line 33 "../kern/syscall.c"
...
sys_env_destroy(envid_t envid)
{
	...
	if ((r = envid2env(envid, &e, 1)) < 0)
		return r;
#line 87 "../kern/syscall.c"
	env_destroy(e);
	return 0;
}
#line 91 "../kern/syscall.c"
...
#line 139 "../kern/syscall.c"
	...
	e->env_status = status;
	return 0;
#line 158 "../kern/syscall.c"
}

#line 161 "../kern/syscall.c"
...
#line 172 "../kern/syscall.c"
	...
	e->env_tf = ltf;
	return 0;
#line 191 "../kern/syscall.c"
}

#line 194 "../kern/syscall.c"
...
#line 482 "../kern/syscall.c"
		if(e->env_type == ENV_TYPE_GUEST) {
			e->env_tf.tf_regs.reg_rsi = value;
		}
#line 486 "../kern/syscall.c"
		return 0;
#line 491 "../kern/syscall.c"
	}
...
#line 508 "../kern/syscall.c"
	...
	sched_yield();
	return 0;
#line 521 "../kern/syscall.c"
}

#line 524 "../kern/syscall.c"

// Return the current time.
static int
sys_time_msec(void)
{
#line 530 "../kern/syscall.c"
	return (int) time_msec();
#line 535 "../kern/syscall.c"
}
#line 537 "../kern/syscall.c"

#line 539 "../kern/syscall.c"
...
#line 554 "../kern/syscall.c"

#line 556 "../kern/syscall.c"
#ifndef VMM_GUEST
static void
sys_vmx_list_vms() {
	vmx_list_vms();
...
#endif //!VMM_GUEST
#line 668 "../kern/syscall.c"

#line 670 "../kern/syscall.c"

// Dispatches to the correct kernel function, passing the arguments.
int64_t
syscall(uint64_t syscallno, uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
#line 683 "../kern/syscall.c"

	switch (syscallno) {
#line 686 "../kern/syscall.c"
	case SYS_cputs:
...
#line 708 "../kern/syscall.c"
	case SYS_env_set_trapframe:
		return sys_env_set_trapframe(a1, (struct Trapframe*) a2);
#line 711 "../kern/syscall.c"
