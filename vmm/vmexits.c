...
{
	/* Your code here */
#line 282 "../vmm/vmexits.c"
	cprintf("Handle cpuid not implemented\n");
	return false;
#line 285 "../vmm/vmexits.c"

}
#line 395 "../vmm/vmexits.c"
...
handle_vmcall(struct Trapframe *tf, struct VmxGuestInfo *gInfo, uint64_t *eptrt)
{
	...
	case VMX_VMCALL_MBMAP:
		...
		/* Your code here */
#line 478 "../vmm/vmexits.c"
		cprintf("e820 map hypercall not implemented\n");	    
		handled = false;
#line 481 "../vmm/vmexits.c"
		break;
	case VMX_VMCALL_IPCSEND:
		...
		/* Your code here */
#line 525 "../vmm/vmexits.c"
		cprintf("IPC send hypercall not implemented\n");	    
		handled = false;
#line 528 "../vmm/vmexits.c"
		break;
	...
	case VMX_VMCALL_IPCRECV:
		...
		/* Your code here */
#line 543 "../vmm/vmexits.c"
		cprintf("IPC recv hypercall not implemented\n");	    
		handled = false;
#line 546 "../vmm/vmexits.c"
		break;
