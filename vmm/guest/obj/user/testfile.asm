...
00000000008028de <ipc_send>:
  ...
  802947:	48 ba 16 56 80 00 00 	movabs $0x805616,%rdx
  80294e:	00 00 00 
  802951:	be 4b 00 00 00       	mov    $0x4b,%esi
  802956:	48 bf 2c 56 80 00 00 	movabs $0x80562c,%rdi
  80295d:	00 00 00 
...
0000000000802a10 <ipc_host_send>:
  ...
  802ab8:	48 ba 16 56 80 00 00 	movabs $0x805616,%rdx
  802abf:	00 00 00 
  802ac2:	be 83 00 00 00       	mov    $0x83,%esi
  802ac7:	48 bf 2c 56 80 00 00 	movabs $0x80562c,%rdi
  802ace:	00 00 00 
...
0000000000802d9b <dev_lookup>:
  ...
  802e25:	48 bf 40 56 80 00 00 	movabs $0x805640,%rdi
  802e2c:	00 00 00 
...
0000000000803074 <read>:
  ...
  8030f8:	48 bf 5f 56 80 00 00 	movabs $0x80565f,%rdi
  8030ff:	00 00 00 
...
00000000008031be <write>:
  ...
  803241:	48 bf 7b 56 80 00 00 	movabs $0x80567b,%rdi
  803248:	00 00 00 
...
00000000008032d7 <ftruncate>:
  ...
  803355:	48 bf 98 56 80 00 00 	movabs $0x805698,%rdi
  80335c:	00 00 00 
...
000000000080365b <devfile_read>:
  ...
  8036c6:	48 b9 be 56 80 00 00 	movabs $0x8056be,%rcx
  8036cd:	00 00 00 
  8036d0:	48 ba c5 56 80 00 00 	movabs $0x8056c5,%rdx
  8036d7:	00 00 00 
  8036da:	be 89 00 00 00       	mov    $0x89,%esi
  8036df:	48 bf da 56 80 00 00 	movabs $0x8056da,%rdi
  8036e6:	00 00 00 
  ...
  803704:	48 b9 e8 56 80 00 00 	movabs $0x8056e8,%rcx
  80370b:	00 00 00 
  80370e:	48 ba c5 56 80 00 00 	movabs $0x8056c5,%rdx
  803715:	00 00 00 
  803718:	be 8a 00 00 00       	mov    $0x8a,%esi
  80371d:	48 bf da 56 80 00 00 	movabs $0x8056da,%rdi
  803724:	00 00 00 
...
0000000000803761 <devfile_write>:
  ...
  80380b:	48 b9 be 56 80 00 00 	movabs $0x8056be,%rcx
  803812:	00 00 00 
  803815:	48 ba c5 56 80 00 00 	movabs $0x8056c5,%rdx
  80381c:	00 00 00 
  80381f:	be a8 00 00 00       	mov    $0xa8,%esi
  803824:	48 bf da 56 80 00 00 	movabs $0x8056da,%rdi
  80382b:	00 00 00 
...
00000000008039ac <copy>:
  ...
  8039ee:	48 bf f4 56 80 00 00 	movabs $0x8056f4,%rdi
  8039f5:	00 00 00 
  ...
  803a3a:	48 bf 0a 57 80 00 00 	movabs $0x80570a,%rdi
  803a41:	00 00 00 
  ...
  803a9f:	48 bf 24 57 80 00 00 	movabs $0x805724,%rdi
  803aa6:	00 00 00 
  ...
  803b1c:	48 bf 37 57 80 00 00 	movabs $0x805737,%rdi
  803b23:	00 00 00 
...
0000000000803ec8 <devsock_stat>:
  ...
  803edc:	48 be 52 57 80 00 00 	movabs $0x805752,%rsi
  803ee3:	00 00 00 
...
00000000008041bc <nsipc_recv>:
  ...
  80422b:	48 b9 59 57 80 00 00 	movabs $0x805759,%rcx
  804232:	00 00 00 
  804235:	48 ba 6e 57 80 00 00 	movabs $0x80576e,%rdx
  80423c:	00 00 00 
  80423f:	be 62 00 00 00       	mov    $0x62,%esi
  804244:	48 bf 83 57 80 00 00 	movabs $0x805783,%rdi
  80424b:	00 00 00 
...
0000000000804288 <nsipc_send>:
  ...
  8042b5:	48 b9 92 57 80 00 00 	movabs $0x805792,%rcx
  8042bc:	00 00 00 
  8042bf:	48 ba 6e 57 80 00 00 	movabs $0x80576e,%rdx
  8042c6:	00 00 00 
  8042c9:	be 6d 00 00 00       	mov    $0x6d,%esi
  8042ce:	48 bf 83 57 80 00 00 	movabs $0x805783,%rdi
  8042d5:	00 00 00 
...
0000000000804589 <_pipeisclosed>:
  ...
  80462f:	48 bf a3 57 80 00 00 	movabs $0x8057a3,%rdi
  804636:	00 00 00 
...
0000000000804888 <devpipe_stat>:
  ...
  8048b3:	48 be b6 57 80 00 00 	movabs $0x8057b6,%rsi
  8048ba:	00 00 00 
...
0000000000804bdb <devcons_stat>:
  ...
  804bef:	48 be c2 57 80 00 00 	movabs $0x8057c2,%rsi
  804bf6:	00 00 00 
